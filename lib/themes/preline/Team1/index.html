...
<div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
  ...
  <div class="grid grid-cols-2 lg:grid-cols-3 gap-8 md:gap-12">
    <div class="grid sm:flex sm:items-center gap-y-3 gap-x-4">
      ...
      <div class="sm:flex sm:flex-col sm:h-full">
        <div>
          ...
          <p class="mt-1 text-xs uppercase text-gray-500">Founder / CEO</p>
        </div>
    ...
    <div class="grid sm:flex sm:items-center gap-y-3 gap-x-4">
      ...
      <div class="sm:flex sm:flex-col sm:h-full">
        <div>
          ...
          <p class="mt-1 text-xs uppercase text-gray-500">UI/UX Designer</p>
        </div>
    ...
    <div class="grid sm:flex sm:items-center gap-y-3 gap-x-4">
      ...
      <div class="sm:flex sm:flex-col sm:h-full">
        <div>
          ...
          <p class="mt-1 text-xs uppercase text-gray-500">Support Consultant</p>
        </div>
    ...
    <div class="grid sm:flex sm:items-center gap-y-3 gap-x-4">
      ...
      <div class="sm:flex sm:flex-col sm:h-full">
        <div>
          <h3 class="font-medium text-gray-800 dark:text-gray-200">Maria Powers</h3>
          <p class="mt-1 text-xs uppercase text-gray-500">Director of sales</p>
        </div>
    ...
    <div class="grid sm:flex sm:items-center gap-y-3 gap-x-4">
      ...
      <div class="sm:flex sm:flex-col sm:h-full">
        <div>
          <h3 class="font-medium text-gray-800 dark:text-gray-200">Delia Pawelke</h3>
          <p class="mt-1 text-xs uppercase text-gray-500">Front-end Developer</p>
        </div>
    ...
    <div class="grid sm:flex sm:items-center gap-y-3 gap-x-4">
      ...
      <div class="sm:flex sm:flex-col sm:h-full">
        <div>
          <h3 class="font-medium text-gray-800 dark:text-gray-200">Tom Lowry</h3>
          <p class="mt-1 text-xs uppercase text-gray-500">UI/UX Designer</p>
        </div>
    ...
    <div class="grid sm:flex sm:items-center gap-y-3 gap-x-4">
      ...
      <div class="sm:flex sm:flex-col sm:h-full">
        <div>
          <h3 class="font-medium text-gray-800 dark:text-gray-200">Louise Donadieu</h3>
          <p class="mt-1 text-xs uppercase text-gray-500">Support Consultant</p>
        </div>
    ...
    <div class="grid sm:flex sm:items-center gap-y-3 gap-x-4">
      ...
      <div class="sm:flex sm:flex-col sm:h-full">
        <div>
          <h3 class="font-medium text-gray-800 dark:text-gray-200">Jeff Fisher</h3>
          <p class="mt-1 text-xs uppercase text-gray-500">Project Manager</p>
        </div>
    ...
    <div class="grid sm:flex sm:items-center gap-y-3 gap-x-4">
      <!-- <img class="rounded-lg w-20 h-20" alt="Image Description"> -->

      <div>
        <h3 class="font-medium text-gray-800 dark:text-gray-200">We are hiring!</h3>
